...
class ImpressionsView{
    function showImpressions($impresiones){
        ...
        foreach($impresiones as $impresion){
            echo '<li class="impresion">' . $impresion->nombre . '<br>' . $impresion->descripcion . '</li>';
        }
        echo "</ul>";
    }
}
...
class TypesView{
    function showTypes($types){
        ...
        foreach ($types as $tipo){
            echo "<li class='col'> <a href='cats/$tipo->id'<br>$tipo->nombre_tipo<br></a>$tipo->descripcion</li>";
        }
        echo "</ul>";
    }
}
